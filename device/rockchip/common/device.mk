...
PRODUCT_COPY_FILES += \
    ...
    device/rockchip/common/ff700030_pwm.kl:system/usr/keylayout/ff700030_pwm.kl
...
TARGET_NXP_NFC_HW := pn7160
$(call inherit-product-if-exists, vendor/nxp/nfc/device-nfc.mk)

$(call inherit-product-if-exists, device/rockchip/common/bin_file/bin_file.mk)
$(call inherit-product-if-exists, device/rockchip/common/EETI_touch/eGTouch.mk)
$(call inherit-product-if-exists, device/rockchip/common/quectel/librild/ril_quectel.mk)
$(call inherit-product-if-exists, device/rockchip/common/quectel/libgps/gps_quectel.mk)
