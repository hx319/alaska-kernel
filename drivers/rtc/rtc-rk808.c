...
#ifdef CONFIG_RTC_DRV_HYM8563
extern int hym8563_get_time(struct rtc_time *rtc_tm);
extern int hym8563_set_time(struct rtc_time *rtc_tm);
...
#ifdef CONFIG_RTC_DRV_HYM8563
  {
    struct rtc_time pcf8563_tm;
    pcf8563_tm.tm_year = tm->tm_year;
    pcf8563_tm.tm_mon = tm->tm_mon;
    pcf8563_tm.tm_mday = tm->tm_mday;
    pcf8563_tm.tm_hour = tm->tm_hour;
    pcf8563_tm.tm_min = tm->tm_min;
    pcf8563_tm.tm_sec = tm->tm_sec;

  	dev_info(dev, "set RTC date/time %4d-%02d-%02d(%d) %02d:%02d:%02d\n", 1900 + tm->tm_year, tm->tm_mon + 1, tm->tm_mday, tm->tm_wday, tm->tm_hour, tm->tm_min, tm->tm_sec);
    hym8563_set_time(&pcf8563_tm);
//    printk("111 time to set %d-%d-%d %d:%d:%d\n", tm->tm_year, tm->tm_mon, tm->tm_mday, tm->tm_hour, tm->tm_min, tm->tm_sec);
  }
#endif
