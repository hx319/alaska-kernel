...
static void inno_dsidphy_mipi_mode_enable(struct inno_dsidphy *inno)
{
  ...
  phy_update_bits(inno, REGISTER_PART_ANALOG, 0x08,	PRE_EMPHASIS_ENABLE_MASK, PRE_EMPHASIS_ENABLE);
  phy_update_bits(inno, REGISTER_PART_ANALOG, 0x08,	DATA_LANE_VOD_RANGE_SET_MASK, DATA_LANE_VOD_RANGE_SET(0xF));
