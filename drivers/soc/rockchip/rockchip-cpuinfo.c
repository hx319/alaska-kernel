...
static int rockchip_cpuinfo_probe(struct platform_device *pdev)
{
  ...
  dev_info(dev, "chip_id: %02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X\n",
    efuse_buf[0], efuse_buf[1], efuse_buf[2], efuse_buf[3], efuse_buf[4], efuse_buf[5], efuse_buf[6], efuse_buf[7],
    efuse_buf[8], efuse_buf[9], efuse_buf[10], efuse_buf[11], efuse_buf[12], efuse_buf[13], efuse_buf[14], efuse_buf[15]);
	kfree(efuse_buf);
