...
//        ulLvdsTXPhyClk = ulDessc_Pix_Clk * 3.5;
    ...
    //printk("ulPclk_Khz: %d, ucPreDiv: %d, ucSericlkDiv: %d, ucPixClkDiv: %lf, ucDivSet: %d",g_stRxVidTiming.ulPclk_Khz, ucPreDiv, ucSericlkDiv, ucPixClkDiv, ucDivSet);
    ...
    HDMI_WriteI2C_Byte(0x19,0xd4); //ssc_prd
        ...
        printk("LVDS Output SSC 1920x1080 30k5%");
        ...
        HDMI_WriteI2C_Byte(0x20,0x00);
        HDMI_WriteI2C_Byte(0x21,0x00);
        printk("LVDS Output SSC 3840x2160 30k5%");
    #endif
