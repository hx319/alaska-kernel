...
// Return      : u32
//========================================================================
u32 Drv_MipiTx_GetMipiInClk(StructMipiTx* pstMipiTx)
{
    u32 ulHalfPixClk = 0;
...
void Drv_MipiTx_DPhySet(void)
{
    ...
    printk("MIPI Output PortB");
    #elif (MIPITX_PORT_SEL == DOU_PORT)
    HDMI_WriteI2C_Byte(0x36,(HDMI_ReadI2C_Byte(0x36) | 0x03));
    printk("MIPI Output PortA & B");
    #endif
    HDMI_WriteI2C_Byte(0xff,0x82);
...
// Return      : void
//========================================================================
void Drv_MipiTx_PllSet(StructMipiTx* pstMipiTx)
{
    u32 ulMpiTXPhyClk;
    ...
    printk( "ulMipiDataRate:%d, ulHalfPixClk:%d, ulMpiTXPhyClk:%d, ucBpp:%d, ucTxPortNum:0x%02x, ucTxLaneNum:0x%02x",
    ...
    printk("ucSericlkDiv N1:0x%02x, ucDivSet M2:0x%02x",ucSericlkDiv, ucDivSet);
}
//========================================================================
...
// Return      : void
//========================================================================
void Drv_MipiTx_PhyTimingParaSet(StructMipiTx* pstMipiTx, StructMipiTxDPhy* pstMipiTxDPhy)
{
    ...
    printk( "ck_post (0xD4A9) = 0x%02x", pstMipiTxDPhy->ucClkPost);
    printk( "ck_zero (0xD4A7) = 0x%02x", pstMipiTxDPhy->ucClkZero);
    printk( "hs_lpx  (0xD4A4) = 0x%02x", pstMipiTxDPhy->ucHsLpx);
    printk( "hs_prep (0xD4A5) = 0x%02x", pstMipiTxDPhy->ucHsPrep);
    printk( "hs_trail(0xD4A6) = 0x%02x", pstMipiTxDPhy->ucHsTrail);
    printk( "hs_rqst (0xD48A) = 0x%02x", pstMipiTxDPhy->ucHsRqStPre);
}
...
// Return      : void
//========================================================================
void Drv_MipiTx_TimingSet(StructVidChkTiming *pstVidTiming)
{
    u16 ushss, usvss;
    u16 us3d_dly;
...
// Return      : void
//========================================================================
void Drv_MipiTx_InHSyncPol_Sel(u8 b1SyncPol)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
...
// Return      : void
//========================================================================
void Drv_MipiTx_InVSyncPol_Sel(u8 b1SyncPol)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
    if (b1SyncPol == NEGITVE)
    {
...
// Return      : void
//========================================================================
void Drv_MipiTx_Hss_Set(u16 usVal)
{
    if( usVal > 0x3FF )
    {
        usVal = 0x3FF;
...
// Return      : void
//========================================================================
void Drv_MipiTx_FifoDelay_Set(u16 rddly)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
...
void Drv_MipiTx_DPHYCSI8Lane_En(u8 b1IsEn)
{
    HDMI_WriteI2C_Byte(0Xff,0xd4);
...
// Return      : void
//========================================================================
void Drv_MipiTx_LaneSet(u8 LaneNum)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
...
void Drv_MipiTx_PortSet(u8 ucTxPortNum)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
...
// Return      : void
//========================================================================
void Drv_MipiTx_DPHYClkMode_Sel(u8 b1IsMipiClockburst)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
...
// Return      : void
//========================================================================
void Drv_MipiTx_HalfWrClkSrc_Sel(u8 clock)
{
    HDMI_WriteI2C_Byte(0xff,0x82);
...
// Return      : void
//========================================================================
void Drv_MipiTx_DsiDataTypeSet(u8 ucTxFormat)
{
    //Data Type set
    HDMI_WriteI2C_Byte(0xff,0xd4);
    switch (ucTxFormat)
...
// Return      : void
//========================================================================
void Drv_MipiTx_CsiDataTypeSet(u8 ucTxFormat)
{
    HDMI_WriteI2C_Byte(0xff,0xd4);
    switch (ucTxFormat)
    {
