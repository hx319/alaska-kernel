...
StructVideoTimingList_ForTtl resolution[]  = {
 {160, 20, 140,1024,  1344,  12,  3,  20,  600, 635,   60},  //video_1024x600_60Hz
...
void Drv_TtlRxDig_Set(void)
{
    ...
    //ttlrx sync mode set
        ...
        HDMI_WriteI2C_Byte(0xc8,HDMI_ReadI2C_Byte(0xc8) | 0x28); //embedded sync mode enable
        printk("Sync Mode:    Embedded");
        ...
        //embedded Half Bit Mode set
            ...
            //DDR Input Mode set
                ...
                printk("DDR Input Mode:    12Bit Mode");
            #endif
        #endif
    #endif
...
void Drv_TtlRxMapping_Set(void)
{
    ...
    switch(TTLRX_INPUT_MODE)
    {
        case INPUT_RGB888:
            ...
            #endif
            ucRxVidFmt = RGB_8Bit;
            printk("TTLRx Input Mode:    RGB888");
            break;
        ...
        case INPUT_RGB666:
            ...
            #endif
            ucRxVidFmt = RGB_6Bit;
            printk("TTLRx Input Mode:    RGB666");
            break;
        ...
        case INPUT_RGB565:
            ...
            #endif
            ucRxVidFmt = RGB_6Bit;
            printk("TTLRx Input Mode:    RGB565");
            break;
        ...
        case INPUT_YCBCR444:
            ...
            printk("TTLRx Input Mode:    YCBCR444");
            break;
        
        case INPUT_YCBCR422_8BIT:
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    YCBCR422_8BIT");
            break;
        
        case INPUT_YCBCR422_10BIT:
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    YCBCR422_10BIT");
            break;
        
        case INPUT_YCBCR422_12BIT:
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    YCBCR422_12BIT");
            break;
        ...
        case INPUT_YCBCR422_16BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    YCBCR422_16BIT");
            break;
        ...
        case INPUT_YCBCR422_20BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    YCBCR422_20BIT");
            break;
        ...
        case INPUT_YCBCR422_24BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    YCBCR422_24BIT");
            break;
        
        case INPUT_BT656_8BIT:
            
            HDMI_WriteI2C_Byte(0xc9,HDMI_ReadI2C_Byte(0xc9) | 0x06);  
            ...
            #endif
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    BT656_8BIT");
            break;
        ...
        case INPUT_BT656_10BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    BT656_10BIT");
            break;
        ...
        case INPUT_BT656_12BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    BT656_12BIT");
            break;
        ...
        case INPUT_BT1120_8BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    BT1120_8BIT");
            break;
        ...
        case INPUT_BT1120_10BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    BT1120_10BIT");
            break;
        ...
        case INPUT_BT1120_12BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    BT1120_12BIT");
            break;
        
        case INPUT_BTA_T1004_16BIT:
              HDMI_WriteI2C_Byte(0xc9,HDMI_ReadI2C_Byte(0xc9) | 0x07);           
        ...
        //RGB swap case
            ...
            #endif
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    BTA_T1004_16BIT");
            break;
        ...
        case INPUT_BTA_T1004_20BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    BTA_T1004_20BIT");
            break;
        ...
        case INPUT_BTA_T1004_24BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    BTA_T1004_24BIT");
            break;
        
        case INPUT_BT1120_16BIT: 
            
        HDMI_WriteI2C_Byte(0xc9,HDMI_ReadI2C_Byte(0xc9) | 0x05);  
            //RGB swap case
            #if 0  //input YUV  C: D7-D0    Y: D15-D8    //8619C /YC no swap /low 16bit output
                HDMI_WriteI2C_Byte(0xc4,0x00);
                HDMI_WriteI2C_Byte(0xc5,0x70);
            ...
            #endif
            ucRxVidFmt = YUV422_8bit;
            printk("TTLRx Input Mode:    BT1120_16BIT");
            break;
        ...
        case INPUT_BT1120_20BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_10bit;
            printk("TTLRx Input Mode:    BT1120_20BIT");
            break;
        ...
        case INPUT_BT1120_24BIT:
            ...
            #endif
            ucRxVidFmt = YUV422_12bit;
            printk("TTLRx Input Mode:    BT1120_24BIT");
            break;
    }
...
u8 Drv_TtlRx_Pll_Set(void)
{
    ...
    for(ucloopx = 0; ucloopx < 5; ucloopx++)
    {
        ...
        {
            printk("Rx Pll Cal done and Lock");
            printk("vmax, vmin = 0x%02x 0x%02x",HDMI_ReadI2C_Byte(0x30) & 0x3f,HDMI_ReadI2C_Byte(0x2f) & 0x3f);
            printk("vcoset = 0x%02x",HDMI_ReadI2C_Byte(0x32) & 0x3f); 
            ucrtn = TRUE;
            break;
        }
        else
               {
            printk("Rx Pll Cal not done");
...
void Drv_TtlRx_TimingSel(u8 uci)
{
    ...
    printk("self timing set:");
    printk("hfp, hs, hbp, hact, htotal = %d %d %d %d %d",VidTiming.usHfp, VidTiming.usHs, VidTiming.usHbp, VidTiming.usHact, VidTiming.usHtotal);
    printk("vfp, vs, vbp, vact, vtotal = %d %d %d %d %d",VidTiming.usVfp, VidTiming.usVs, VidTiming.usVbp, VidTiming.usVact, VidTiming.usVtotal);
}
...
void Drv_TtlRx_SelfTimingSet(void)
{
    ...
    printk("self timing phase check:");
    for(ucphase = 0; ucphase < 10; ucphase++)
    {
        ...
        printk("phase: 0x%02x", ucphase);
        printk("hact, htotal, vact, vtotal = %d %d %d %d",ushact, ushtotal, usvact, usvtotal);
    }
    #else
        ...
        printk("************timing set phase: 0x%02x", ucphase);
    #endif
    ...
    {
        ushact = (ushact - 2);
        printk("flag check:   BTA_T1004");
    }
    else if(HDMI_ReadI2C_Byte(0xbf) & 0x02)
    {
        ushact = (ushact - 2);
        printk("flag check:   BT656");
    }
    else if(HDMI_ReadI2C_Byte(0xbf) & 0x04)
    {
        ushact = (ushact - 4);
        printk("flag check:   8bit BT1120");
    }
    else if(HDMI_ReadI2C_Byte(0xbf) & 0x08)
    {
        ushact = (ushact - 4);
        printk("flag check:   16bit BT1120");
    }
    else
    {
        printk("No flag fit!");
    ...
    for (uci = 0; uci < ucResolutionnum; uci++)
    {
        ...
        {            
            printk("uci fit = 0x%02x",uci);
            printk("ucihact, ucivact = %d %d", resolution[uci].usHact, resolution[uci].usVact);
...
void Drv_TtlRx_DeSyncModeSet(void)
{
    ...
    usHact = TTLRX_DE_SYNC_MODE_HACT;
    usVact = TTLRX_DE_SYNC_MODE_VACT;
    ucResolutionnum = sizeof(resolution) / sizeof(resolution[0]);
    ...
    printk("vfp, vs, vbp, vact, vtotal = %d %d %d %d %d",usVfp, usVs, usVbp, usVact, usVtotal);
         ...
         msleep(100);
         HDMI_WriteI2C_Byte(0xff,0x86);
         sync_polarity = HDMI_ReadI2C_Byte(0x4f);
         printk("TTL input sync_polarity = 0x%02x", sync_polarity);
         
       if(!(sync_polarity & 0x04)) //hsync
	{
        HDMI_WriteI2C_Byte(0xff,0x85);
        HDMI_WriteI2C_Byte(0xc7, (HDMI_ReadI2C_Byte(0xc7) & BIT0_0));
        printk("sync mode enable, set hsync pol");
	}
	if(!(sync_polarity & 0x08)) //vsync
	{
        HDMI_WriteI2C_Byte(0xff,0x85);
        HDMI_WriteI2C_Byte(0xc7, (HDMI_ReadI2C_Byte(0xc7) & BIT1_0));
        printk("sync mode enable, set vsync pol");
	}
         
        HDMI_WriteI2C_Byte(0xff,0x85);
        HDMI_WriteI2C_Byte(0xc7,(HDMI_ReadI2C_Byte(0xc7) & BIT2_0));
        HDMI_WriteI2C_Byte(0xc7,HDMI_ReadI2C_Byte(0xc7) | 0x80); //de_gen enable
        printk("sync mode enable, generate de");
    
    #elif TTLRX_DE_SYNC_MODE == TTL_DE_MODE
        HDMI_WriteI2C_Byte(0xc7,HDMI_ReadI2C_Byte(0xc7) | 0x40); //sync_gen enable
        printk("de mode enable, generate sync");
    #endif
    #if TTLRX_VIDEO_FORMAT == P_FORMAT
...
void Drv_TtlRx_ClkChkDebug(void)
{
    u32 fm_value;
     ...
     HDMI_WriteI2C_Byte(0xff,0x86);
    HDMI_WriteI2C_Byte(0X90,0x19);
    msleep(5);
    if ((HDMI_ReadI2C_Byte(0x98) & 0x60) == 0x60)
	{
		printk("FM CLOCK DET Stable");
	}
    else
	{
        printk("Frequency meter output clock status unStable");
	}
    
    HDMI_WriteI2C_Byte(0x90,0x99);
    fm_value = (HDMI_ReadI2C_Byte(0x98) & 0x0f);
    fm_value = (fm_value << 8) + HDMI_ReadI2C_Byte(0x99);
    fm_value = (fm_value << 8) + HDMI_ReadI2C_Byte(0x9a);
    HDMI_WriteI2C_Byte(0x90,(HDMI_ReadI2C_Byte(0x90) & BIT7_0));
 
    printk("TTL input dclock: %d",fm_value);
}
void Drv_TtlRx_VidChkDebug(void)
{
    ...
    u8 ucphase;
        ...
        printk("************video check phase: 0x%02x", ucphase);
        printk("sync_polarity = 0x%02x", ucsync_polarity);
        printk("hfp, hs, hbp, hact, htotal = %d %d %d %d %d",ushfp, ushs, ushbp, ushact, ushtotal);
        printk("vfp, vs, vbp, vact, vtotal = %d %d %d %d %d",usvfp, usvs, usvbp, usvact, usvtotal);
    #endif
