...
void Mod_MipiTxVidFmt_Get(void)
{
...
void Mod_MipiTx_ParaSet(void)
{
    ...
    printk("burst:0x%02x", g_stMipiTx.b1MipiClockburst);
    ...
    {
        printk("Over Maximum MIPITX Datarate");
    }
...
//    ulrddly = (ulrddly_max - ulrddly_min2) / 20 + ulrddly_min2;
    ...
    printk("rddly is 0x%04x;",ulrddly);          
}
...
void Mod_MipiTx_Digital_Config(void)
{
    ...
    #endif
    printk( "MipiTx Output Format: %s",g_szStrTxFormat[g_stMipiTx.ucTxFormat]);
}
