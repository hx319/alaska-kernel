...
extern u8 Drv_MipiRptClk_Change(void);
extern void Drv_MipiRpt_ClkSel(void);
extern void Drv_MipiRptTx_SkewCali(void);
extern void Drv_MipiRptRxPhy_Set(void);
extern void Drv_MipiRptRxDig_Set(void);
extern void Drv_MipiRptTxPhy_Set(void);
extern u8 Drv_MipiRptRx_ByteClkGet(void);
