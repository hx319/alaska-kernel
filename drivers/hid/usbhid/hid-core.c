 ...
 * Module parameters.
 */
static int egtouch_connect = 0;
module_param_named(egtouch_connect, egtouch_connect, int, 0664);
MODULE_PARM_DESC(egtouch_connect, "egtouch_connect");
