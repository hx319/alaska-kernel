...
#define RTL_8211FV_PHY_ID  0x001CC878
static int phy_rtl8211f_led_fixup(struct phy_device *phydev)
{
  printk("%s\n", __func__);
  /* Set green LED for Link, yellow LED for Active */
  phy_write(phydev, 0x1F, 0x0D04);
//  phy_write(phydev, 0x10, 0x6D6B);  //G-LED1 Y-LED2
  phy_write(phydev, 0x10, 0x6F6B);  //G-LED0 Y-LED1
...
static int phy_rtl8201f_fixup(struct phy_device *phydev)
{
  ...
  msleep(10);
  phy_write(phydev, 0x11, 0x00B3);
  msleep(10);
  phy_write(phydev, 0x13, 0xC03C);
  msleep(10);
  phy_write(phydev, 0x1F, 0x0000);
  return 0;
}
...
static int phy_rtl8211e_led_fixup(struct phy_device *phydev)
{
  ...
  phy_write(phydev, 0x1C, 0x0777);
  phy_write(phydev, 0x1A, 0x0010);
  phy_write(phydev, 0x1F, 0x0000);
  return 0;
}

#define RPC8211FP_PHY_ID  0x0008011B
static int phy_rpc8211fp_fixup(struct phy_device *phydev)
{
  printk("%s\n", __func__);
  //output 125Msync-clock
  phy_write(phydev, 0x1E, 0xA012);
  phy_write(phydev, 0x1F, 0x00D0);
  //LED
  phy_write(phydev, 0x1E, 0xA00C);
  phy_write(phydev, 0x1F, 0x0070);
  phy_write(phydev, 0x1E, 0xA00D);
  phy_write(phydev, 0x1F, 0x0670);
  //RESET
  phy_write(phydev, 0x00, 0x9140);
  return 0;
}

#define JL2XX1_PHY_ID  0x937C4030
static int phy_jl2xx1_fixup(struct phy_device *phydev)
{
  printk("%s\n", __func__);
  //output 125Msync-clock
  phy_write(phydev, 0x1F, 0x0A43);
  phy_write(phydev, 0x19, 0x0801);
  //LED
  phy_write(phydev, 0x1F, 0x0D04);
  phy_write(phydev, 0x10, 0x836B);
  //RESET
  phy_write(phydev, 0x1F, 0x0000);
  phy_write(phydev, 0x00, 0x9140);
  msleep(400);
...
static int phy_yt8512c_fixup(struct phy_device *phydev)
{
  printk("%s\n", __func__);
  /* Set green LED for Link, yellow LED for Active */
		     ...
		     struct stmmac_resources *res)
{
  ...
  phy_register_fixup_for_uid(RTL_8211F_PHY_ID, 0x001FFFFF, phy_rtl8211f_led_fixup);
  phy_register_fixup_for_uid(RTL_8211FV_PHY_ID, 0x001FFFFF, phy_rtl8211f_led_fixup);
  phy_register_fixup_for_uid(RTL8201F_PHY_ID, 0x001FFFFF, phy_rtl8201f_fixup);
  phy_register_fixup_for_uid(RTL_8211E_PHY_ID, 0x001FFFFF, phy_rtl8211e_led_fixup);
  phy_register_fixup_for_uid(RPC8211FP_PHY_ID, 0xFFFFFFFF, phy_rpc8211fp_fixup);
  phy_register_fixup_for_uid(JL2XX1_PHY_ID, 0xFFFFFFF0, phy_jl2xx1_fixup);
  phy_register_fixup_for_uid(YT8512C_PHY_ID, 0xFFFFFFFF, phy_yt8512c_fixup);
